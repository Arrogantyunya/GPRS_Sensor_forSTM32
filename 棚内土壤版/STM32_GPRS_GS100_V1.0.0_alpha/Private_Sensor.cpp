...
{
  CJMCU6750_Sensor.begin(PB15, PB14);

  CJMCU6750_Sensor.beginTransmission(I2C_ADDR);
  CJMCU6750_Sensor.write((IT_1 << 2) | 0x02);
  CJMCU6750_Sensor.endTransmission();
  delay(500);
...
#if LUX_UV
  CJMCU6750_Sensor.requestFrom(I2C_ADDR + 1, 1); //MSB
  delay(1);

  if (CJMCU6750_Sensor.available())
    msb = CJMCU6750_Sensor.read();

  CJMCU6750_Sensor.requestFrom(I2C_ADDR + 0, 1); //LSB
  delay(1);

  if (CJMCU6750_Sensor.available())
    lsb = CJMCU6750_Sensor.read();
...
//读取雨雪传感器开关量
  ...
  Serial.print(Muti_Sensor_Data.Air_Humi);
  Serial.println("%RH");
  Serial.print("Air Atmos: ");
  Serial.print(Muti_Sensor_Data.Air_Atmos);
  Serial.println("Pa");
  Serial.print("Air Lux: ");
  Serial.print(Muti_Sensor_Data.Air_Lux);
  Serial.println("Lux");
  Serial.print("Air uv: ");
  Serial.println(Muti_Sensor_Data.Air_UV);
  Serial.print("Air CO2: ");
  Serial.print(Muti_Sensor_Data.Air_CO2);
  Serial.println("ppm");
  Serial.print("Air TVOC: ");
  Serial.print(Muti_Sensor_Data.Air_TVOC);
  Serial.println("ppm");
  Serial.print("Wind Speed: ");
  Serial.print(Muti_Sensor_Data.Air_Wind_Speed);
  Serial.println("m/s");
  Serial.print("Wind Direction:");
  Serial.println(Muti_Sensor_Data.Wind_DirCode);
  ...
  Serial.print(Muti_Sensor_Data.Soil_Humi);
  Serial.println("%RH");
  Serial.print("Soil Cond: ");
  Serial.print(Muti_Sensor_Data.Soil_Cond);
  Serial.println("us/cm");
  Serial.print("Soil Salt；");
  Serial.print(Muti_Sensor_Data.Soil_Salt);
  Serial.println("mg/L");
  ...
  Serial.println("℃");
  Serial.print("GreenHouse Humi: ");
  Serial.print(Muti_Sensor_Data.GreenHouse_Humi);
  Serial.println("%RH");
  Serial.print("GreenHouse Atmos: ");
  Serial.print(Muti_Sensor_Data.GreenHouse_Atmos);
  Serial.println("Pa");
  Serial.print("GreenHouse Lux: ");
  Serial.print(Muti_Sensor_Data.GreenHouse_Lux);
  Serial.println("Lux");
  Serial.print("GreenHouse uv: ");
  Serial.println(Muti_Sensor_Data.GreenHouse_UV);
  Serial.print("GreenHouse CO2: ");
  Serial.print(Muti_Sensor_Data.GreenHouse_CO2);
  Serial.println("ppm");
  Serial.print("GreenHouse TVOC: ");
  Serial.print(Muti_Sensor_Data.GreenHouse_TVOC);
  Serial.println("ppm");
#endif
